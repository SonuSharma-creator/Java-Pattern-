...
I will solve **one pattern every day** and push the solution to GitHub.
...
* Improve nested loop understanding
...
**30 Patterns → 30 Days → 1 GitHub Repository → Stronger Java Logic**

> **Consistency over perfection. One pattern every day.**
